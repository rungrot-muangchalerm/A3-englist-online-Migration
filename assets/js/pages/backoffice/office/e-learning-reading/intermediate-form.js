...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/e-learning-reading/intermediate';
...
fetch(`/api/backoffice/office/topics/11-02/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
