...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/e-learning-reading/advance';
...
fetch(`/api/backoffice/office/topics/11-03/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
