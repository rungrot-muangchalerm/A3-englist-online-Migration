...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/e-learning-reading/ielts';
...
fetch(`/api/backoffice/office/topics/11-05/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
