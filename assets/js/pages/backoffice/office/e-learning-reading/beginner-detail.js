...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/e-learning-reading/beginner';

fetch(`/api/backoffice/office/topics/11-01/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
