...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/e-learning-reading/toeic';

fetch(`/api/backoffice/office/topics/11-04/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
