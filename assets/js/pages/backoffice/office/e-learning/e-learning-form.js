...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/e-learning/e-learning';
...
fetch(`/api/backoffice/office/topics/10-01/${encodeURIComponent(officeTopicFormTopicId)}`, {
    credentials: 'include'
