...
const mainMenuDetailListUrl = '/backoffice/mainoffice/office/main-menu/contact-us';

fetch(`/api/backoffice/office/topics/01-03/${encodeURIComponent(mainMenuDetailTopicId)}`, {
  credentials: 'include'
