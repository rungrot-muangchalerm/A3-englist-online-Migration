...
const mainMenuDetailListUrl = '/backoffice/mainoffice/office/main-menu/webboard';

fetch(`/api/backoffice/office/topics/01-02/${encodeURIComponent(mainMenuDetailTopicId)}`, {
  credentials: 'include'
