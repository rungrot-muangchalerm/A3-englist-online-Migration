...
const mainMenuFormListUrl = '/backoffice/mainoffice/office/main-menu/eol-history';
...
fetch(`/api/backoffice/office/topics/01-08/${encodeURIComponent(mainMenuFormTopicId)}`, {
  credentials: 'include'
