...
const mainMenuDetailListUrl = '/backoffice/mainoffice/office/main-menu/eol-vdo';

fetch(`/api/backoffice/office/topics/01-09/${encodeURIComponent(mainMenuDetailTopicId)}`, {
  credentials: 'include'
