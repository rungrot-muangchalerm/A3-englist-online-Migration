...
const mainMenuDetailListUrl = '/backoffice/mainoffice/office/main-menu/what-is-eol';

fetch(`/api/backoffice/office/topics/01-06/${encodeURIComponent(mainMenuDetailTopicId)}`, {
  credentials: 'include'
