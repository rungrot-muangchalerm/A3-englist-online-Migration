...
const mainMenuDetailListUrl = '/backoffice/mainoffice/office/main-menu/about-us';

fetch(`/api/backoffice/office/topics/01-01/${encodeURIComponent(mainMenuDetailTopicId)}`, {
  credentials: 'include'
