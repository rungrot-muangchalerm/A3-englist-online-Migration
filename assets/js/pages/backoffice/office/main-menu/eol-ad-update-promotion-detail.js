...
const mainMenuDetailListUrl = '/backoffice/mainoffice/office/main-menu/eol-ad-update-promotion';

fetch(`/api/backoffice/office/topics/01-07/${encodeURIComponent(mainMenuDetailTopicId)}`, {
  credentials: 'include'
