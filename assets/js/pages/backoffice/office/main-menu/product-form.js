...
const mainMenuFormListUrl = '/backoffice/mainoffice/office/main-menu/product';
...
fetch(`/api/backoffice/office/topics/01-04/${encodeURIComponent(mainMenuFormTopicId)}`, {
  credentials: 'include'
