...
const mainMenuFormListUrl = '/backoffice/mainoffice/office/main-menu/contact-us';
...
fetch(`/api/backoffice/office/topics/01-03/${encodeURIComponent(mainMenuFormTopicId)}`, {
  credentials: 'include'
