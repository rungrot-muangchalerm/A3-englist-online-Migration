...
const mainMenuDetailListUrl = '/backoffice/mainoffice/office/main-menu/how-to-use-eol';

fetch(`/api/backoffice/office/topics/01-05/${encodeURIComponent(mainMenuDetailTopicId)}`, {
  credentials: 'include'
