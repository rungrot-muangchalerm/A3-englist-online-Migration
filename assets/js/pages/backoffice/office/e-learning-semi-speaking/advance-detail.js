...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/e-learning-semi-speaking/advance';

fetch(`/api/backoffice/office/topics/13-03/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
