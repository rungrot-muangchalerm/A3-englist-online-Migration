...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/e-learning-semi-speaking/ielts';
...
fetch(`/api/backoffice/office/topics/13-05/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
