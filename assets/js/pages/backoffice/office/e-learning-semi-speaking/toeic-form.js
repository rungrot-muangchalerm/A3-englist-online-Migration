...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/e-learning-semi-speaking/toeic';
...
fetch(`/api/backoffice/office/topics/13-04/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
