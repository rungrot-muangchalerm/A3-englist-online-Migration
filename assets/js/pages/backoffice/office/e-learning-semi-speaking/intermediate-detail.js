...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/e-learning-semi-speaking/intermediate';

fetch(`/api/backoffice/office/topics/13-02/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
