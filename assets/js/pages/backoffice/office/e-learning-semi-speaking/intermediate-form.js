...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/e-learning-semi-speaking/intermediate';
...
fetch(`/api/backoffice/office/topics/13-02/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
