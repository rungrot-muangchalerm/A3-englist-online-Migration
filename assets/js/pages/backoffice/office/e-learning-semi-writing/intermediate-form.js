...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/e-learning-semi-writing/intermediate';
...
fetch(`/api/backoffice/office/topics/14-02/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
