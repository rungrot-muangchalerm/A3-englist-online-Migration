...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/e-learning-semi-writing/ielts';
...
fetch(`/api/backoffice/office/topics/14-05/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
