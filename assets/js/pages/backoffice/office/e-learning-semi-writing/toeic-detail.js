...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/e-learning-semi-writing/toeic';

fetch(`/api/backoffice/office/topics/14-04/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
