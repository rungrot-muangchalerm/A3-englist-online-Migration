...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/e-learning-semi-writing/advance';

fetch(`/api/backoffice/office/topics/14-03/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
