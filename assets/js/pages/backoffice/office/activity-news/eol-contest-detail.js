...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/activity-news/eol-contest';

fetch(`/api/backoffice/office/topics/02-03/${encodeURIComponent(officeTopicDetailTopicId)}`, {
    credentials: 'include'
