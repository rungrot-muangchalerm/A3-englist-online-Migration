...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/activity-news/eol-pr-news';
...
fetch(`/api/backoffice/office/topics/02-02/${encodeURIComponent(officeTopicFormTopicId)}`, {
    credentials: 'include'
