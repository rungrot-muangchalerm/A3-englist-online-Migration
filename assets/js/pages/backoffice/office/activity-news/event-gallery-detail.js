...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/activity-news/event-gallery';

fetch(`/api/backoffice/office/topics/02-01/${encodeURIComponent(officeTopicDetailTopicId)}`, {
    credentials: 'include'
