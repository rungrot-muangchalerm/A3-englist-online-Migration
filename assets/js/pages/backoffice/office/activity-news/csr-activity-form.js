...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/activity-news/csr-activity';
...
fetch(`/api/backoffice/office/topics/02-05/${encodeURIComponent(officeTopicFormTopicId)}`, {
    credentials: 'include'
