...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/activity-news/advertising';
...
fetch(`/api/backoffice/office/topics/02-06/${encodeURIComponent(officeTopicFormTopicId)}`, {
    credentials: 'include'
