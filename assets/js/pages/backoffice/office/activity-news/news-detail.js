...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/activity-news/news';

fetch(`/api/backoffice/office/topics/02-07/${encodeURIComponent(officeTopicDetailTopicId)}`, {
    credentials: 'include'
