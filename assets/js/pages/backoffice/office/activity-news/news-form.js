...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/activity-news/news';
...
fetch(`/api/backoffice/office/topics/02-07/${encodeURIComponent(officeTopicFormTopicId)}`, {
    credentials: 'include'
