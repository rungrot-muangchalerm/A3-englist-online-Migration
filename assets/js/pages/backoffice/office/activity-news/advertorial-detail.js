...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/activity-news/advertorial';

fetch(`/api/backoffice/office/topics/02-08/${encodeURIComponent(officeTopicDetailTopicId)}`, {
    credentials: 'include'
