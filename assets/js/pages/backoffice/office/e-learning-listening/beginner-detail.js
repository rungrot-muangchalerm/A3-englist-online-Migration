...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/e-learning-listening/beginner';

fetch(`/api/backoffice/office/topics/12-01/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
