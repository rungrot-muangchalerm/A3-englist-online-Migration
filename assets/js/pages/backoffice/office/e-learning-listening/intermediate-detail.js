...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/e-learning-listening/intermediate';

fetch(`/api/backoffice/office/topics/12-02/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
