...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/e-learning-listening/advance';

fetch(`/api/backoffice/office/topics/12-03/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
