...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/e-learning-listening/ielts';
...
fetch(`/api/backoffice/office/topics/12-05/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
