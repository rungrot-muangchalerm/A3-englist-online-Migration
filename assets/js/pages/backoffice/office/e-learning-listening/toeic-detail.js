...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/e-learning-listening/toeic';

fetch(`/api/backoffice/office/topics/12-04/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
