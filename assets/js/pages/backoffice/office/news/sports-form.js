...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/news/sports';
...
fetch(`/api/backoffice/office/topics/04-05/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
