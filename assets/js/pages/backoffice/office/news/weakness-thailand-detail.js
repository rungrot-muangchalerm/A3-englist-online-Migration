...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/news/weakness-thailand';

fetch(`/api/backoffice/office/topics/04-02/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
