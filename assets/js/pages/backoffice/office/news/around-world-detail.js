...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/news/around-world';

fetch(`/api/backoffice/office/topics/04-04/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
