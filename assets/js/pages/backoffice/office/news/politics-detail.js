...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/news/politics';

fetch(`/api/backoffice/office/topics/04-01/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
