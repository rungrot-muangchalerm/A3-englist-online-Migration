...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/news/politics';
...
fetch(`/api/backoffice/office/topics/04-01/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
