...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/news/education';
...
fetch(`/api/backoffice/office/topics/04-03/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
