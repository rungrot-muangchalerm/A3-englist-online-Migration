...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/interesting/eol-english-tips';
...
fetch(`/api/backoffice/office/topics/03-14/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
