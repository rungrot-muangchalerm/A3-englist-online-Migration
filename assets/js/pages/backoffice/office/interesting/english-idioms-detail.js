...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/interesting/english-idioms';

fetch(`/api/backoffice/office/topics/03-03/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
