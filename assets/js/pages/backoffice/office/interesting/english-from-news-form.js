...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/interesting/english-from-news';
...
fetch(`/api/backoffice/office/topics/03-12/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
