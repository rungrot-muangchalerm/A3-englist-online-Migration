...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/interesting/english-through-sports';
...
fetch(`/api/backoffice/office/topics/03-09/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
