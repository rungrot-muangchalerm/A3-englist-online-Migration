...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/interesting/pronunciation-phonetic';

fetch(`/api/backoffice/office/topics/03-08/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
