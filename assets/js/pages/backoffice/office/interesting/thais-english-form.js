...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/interesting/thais-english';
...
fetch(`/api/backoffice/office/topics/03-02/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
