...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/interesting/english-through-songs';
...
fetch(`/api/backoffice/office/topics/03-07/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
