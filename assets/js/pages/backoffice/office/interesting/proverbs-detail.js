...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/interesting/proverbs';

fetch(`/api/backoffice/office/topics/03-16/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
