...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/interesting/english-from-news';

fetch(`/api/backoffice/office/topics/03-12/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
