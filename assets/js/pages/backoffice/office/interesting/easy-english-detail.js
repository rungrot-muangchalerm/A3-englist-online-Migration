...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/interesting/easy-english';

fetch(`/api/backoffice/office/topics/03-10/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
