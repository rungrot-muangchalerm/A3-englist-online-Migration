...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/interesting/communicative-english';

fetch(`/api/backoffice/office/topics/03-15/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
