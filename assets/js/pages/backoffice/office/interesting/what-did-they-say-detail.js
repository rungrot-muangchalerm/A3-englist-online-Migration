...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/interesting/what-did-they-say';

fetch(`/api/backoffice/office/topics/03-06/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
