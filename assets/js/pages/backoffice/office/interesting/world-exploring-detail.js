...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/interesting/world-exploring';

fetch(`/api/backoffice/office/topics/03-04/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
