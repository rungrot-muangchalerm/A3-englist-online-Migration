...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/interesting/slang';

fetch(`/api/backoffice/office/topics/03-13/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
