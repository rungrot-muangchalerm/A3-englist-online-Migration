...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/interesting/one-day-one-sentence';

fetch(`/api/backoffice/office/topics/03-01/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
