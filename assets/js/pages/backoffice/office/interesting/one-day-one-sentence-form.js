...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/interesting/one-day-one-sentence';
...
fetch(`/api/backoffice/office/topics/03-01/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
