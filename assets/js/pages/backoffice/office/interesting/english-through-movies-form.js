...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/interesting/english-through-movies';
...
fetch(`/api/backoffice/office/topics/03-05/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
