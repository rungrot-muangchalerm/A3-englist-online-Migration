...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/interesting/effective-writing';
...
fetch(`/api/backoffice/office/topics/03-11/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
