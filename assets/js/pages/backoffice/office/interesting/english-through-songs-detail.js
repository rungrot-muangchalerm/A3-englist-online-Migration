...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/interesting/english-through-songs';

fetch(`/api/backoffice/office/topics/03-07/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
