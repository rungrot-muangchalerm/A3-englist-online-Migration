...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/interesting/eol-english-tips';

fetch(`/api/backoffice/office/topics/03-14/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
