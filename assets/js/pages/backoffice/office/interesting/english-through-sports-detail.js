...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/interesting/english-through-sports';

fetch(`/api/backoffice/office/topics/03-09/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
