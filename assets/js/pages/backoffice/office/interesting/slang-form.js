...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/interesting/slang';
...
fetch(`/api/backoffice/office/topics/03-13/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
