...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/interesting/english-through-movies';

fetch(`/api/backoffice/office/topics/03-05/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
