...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/interesting/thais-english';

fetch(`/api/backoffice/office/topics/03-02/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
