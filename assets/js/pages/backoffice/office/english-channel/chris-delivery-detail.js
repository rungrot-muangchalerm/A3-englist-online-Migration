...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/english-channel/chris-delivery';

fetch(`/api/backoffice/office/topics/06-02/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
