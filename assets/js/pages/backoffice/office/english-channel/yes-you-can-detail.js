...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/english-channel/yes-you-can';

fetch(`/api/backoffice/office/topics/06-03/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
