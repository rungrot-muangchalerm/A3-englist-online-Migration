...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/english-channel/yes-you-can';
...
fetch(`/api/backoffice/office/topics/06-03/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
