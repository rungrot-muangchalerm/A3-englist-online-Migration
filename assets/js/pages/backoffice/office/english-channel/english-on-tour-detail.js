...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/english-channel/english-on-tour';

fetch(`/api/backoffice/office/topics/06-01/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
