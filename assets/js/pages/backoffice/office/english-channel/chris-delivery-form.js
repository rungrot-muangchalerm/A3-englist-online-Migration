...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/english-channel/chris-delivery';
...
fetch(`/api/backoffice/office/topics/06-02/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
