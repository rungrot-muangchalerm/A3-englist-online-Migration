...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/e-learning-vocabulary/intermediate';
...
fetch(`/api/backoffice/office/topics/17-02/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
