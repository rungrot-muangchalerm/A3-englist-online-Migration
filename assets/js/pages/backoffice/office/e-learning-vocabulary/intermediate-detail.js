...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/e-learning-vocabulary/intermediate';

fetch(`/api/backoffice/office/topics/17-02/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
