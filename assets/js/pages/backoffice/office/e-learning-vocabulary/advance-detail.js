...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/e-learning-vocabulary/advance';

fetch(`/api/backoffice/office/topics/17-03/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
