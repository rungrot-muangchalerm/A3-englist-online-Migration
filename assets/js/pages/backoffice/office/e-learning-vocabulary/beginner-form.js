...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/e-learning-vocabulary/beginner';
...
fetch(`/api/backoffice/office/topics/17-01/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
