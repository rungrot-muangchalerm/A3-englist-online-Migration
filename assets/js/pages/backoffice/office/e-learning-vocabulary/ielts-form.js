...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/e-learning-vocabulary/ielts';
...
fetch(`/api/backoffice/office/topics/17-05/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
