...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/e-learning-vocabulary/toeic';
...
fetch(`/api/backoffice/office/topics/17-04/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
