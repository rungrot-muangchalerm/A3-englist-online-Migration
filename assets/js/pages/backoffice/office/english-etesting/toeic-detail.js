...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/english-etesting/toeic';

fetch(`/api/backoffice/office/topics/07-06/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
