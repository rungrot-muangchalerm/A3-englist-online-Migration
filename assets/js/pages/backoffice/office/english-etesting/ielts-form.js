...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/english-etesting/ielts';
...
fetch(`/api/backoffice/office/topics/07-07/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
