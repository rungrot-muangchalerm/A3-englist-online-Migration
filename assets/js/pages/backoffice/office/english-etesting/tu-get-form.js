...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/english-etesting/tu-get';
...
fetch(`/api/backoffice/office/topics/07-04/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
