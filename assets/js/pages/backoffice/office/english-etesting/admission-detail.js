...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/english-etesting/admission';

fetch(`/api/backoffice/office/topics/07-02/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
