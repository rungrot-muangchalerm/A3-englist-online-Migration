...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/english-etesting/e-testing';
...
fetch(`/api/backoffice/office/topics/07-01/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
