...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/english-etesting/e-testing';

fetch(`/api/backoffice/office/topics/07-01/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
