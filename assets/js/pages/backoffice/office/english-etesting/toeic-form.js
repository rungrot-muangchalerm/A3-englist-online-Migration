...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/english-etesting/toeic';
...
fetch(`/api/backoffice/office/topics/07-06/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
