...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/english-etesting/cu-tep';
...
fetch(`/api/backoffice/office/topics/07-03/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
