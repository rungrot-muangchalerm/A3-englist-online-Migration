...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/english-etesting/admission';
...
fetch(`/api/backoffice/office/topics/07-02/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
