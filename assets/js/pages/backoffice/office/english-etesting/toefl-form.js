...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/english-etesting/toefl';
...
fetch(`/api/backoffice/office/topics/07-05/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
