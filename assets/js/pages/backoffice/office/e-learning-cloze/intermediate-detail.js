...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/e-learning-cloze/intermediate';

fetch(`/api/backoffice/office/topics/16-02/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
