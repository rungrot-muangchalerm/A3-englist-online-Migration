...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/e-learning-cloze/ielts';
...
fetch(`/api/backoffice/office/topics/16-05/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
