...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/e-learning-cloze/advance';
...
fetch(`/api/backoffice/office/topics/16-03/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
