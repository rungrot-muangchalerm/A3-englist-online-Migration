...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/e-learning-cloze/beginner';
...
fetch(`/api/backoffice/office/topics/16-01/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
