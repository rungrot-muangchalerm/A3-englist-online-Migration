...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/e-learning-cloze/toeic';
...
fetch(`/api/backoffice/office/topics/16-04/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
