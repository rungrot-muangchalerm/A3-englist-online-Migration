...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/e-learning-cloze/intermediate';
...
fetch(`/api/backoffice/office/topics/16-02/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
