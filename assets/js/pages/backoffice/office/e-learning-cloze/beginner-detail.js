...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/e-learning-cloze/beginner';

fetch(`/api/backoffice/office/topics/16-01/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
