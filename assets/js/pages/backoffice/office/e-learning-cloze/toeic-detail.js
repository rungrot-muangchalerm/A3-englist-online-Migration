...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/e-learning-cloze/toeic';

fetch(`/api/backoffice/office/topics/16-04/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
