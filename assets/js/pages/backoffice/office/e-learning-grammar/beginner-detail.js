...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/e-learning-grammar/beginner';

fetch(`/api/backoffice/office/topics/15-01/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
