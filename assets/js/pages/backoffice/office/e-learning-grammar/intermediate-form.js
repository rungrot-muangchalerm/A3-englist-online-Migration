...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/e-learning-grammar/intermediate';
...
fetch(`/api/backoffice/office/topics/15-02/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
