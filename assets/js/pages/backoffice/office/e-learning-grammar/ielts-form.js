...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/e-learning-grammar/ielts';
...
fetch(`/api/backoffice/office/topics/15-05/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
