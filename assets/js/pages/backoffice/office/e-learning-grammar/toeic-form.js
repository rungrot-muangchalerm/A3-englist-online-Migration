...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/e-learning-grammar/toeic';
...
fetch(`/api/backoffice/office/topics/15-04/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
