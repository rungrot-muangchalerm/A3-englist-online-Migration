...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/e-learning-grammar/advance';

fetch(`/api/backoffice/office/topics/15-03/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
