...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/e-learning-grammar/intermediate';

fetch(`/api/backoffice/office/topics/15-02/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
