...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/e-learning-grammar/toeic';

fetch(`/api/backoffice/office/topics/15-04/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
