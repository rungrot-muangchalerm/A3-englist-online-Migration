...
const officeTopicFormListUrl = '/backoffice/mainoffice/office/entertainment/health-care';
...
fetch(`/api/backoffice/office/topics/05-01/${encodeURIComponent(officeTopicFormTopicId)}`, {
  credentials: 'include'
