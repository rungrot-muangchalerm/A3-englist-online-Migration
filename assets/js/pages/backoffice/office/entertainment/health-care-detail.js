...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/entertainment/health-care';

fetch(`/api/backoffice/office/topics/05-01/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
