...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/entertainment/travel';

fetch(`/api/backoffice/office/topics/05-03/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
