...
const officeTopicDetailListUrl = '/backoffice/mainoffice/office/entertainment/food';

fetch(`/api/backoffice/office/topics/05-02/${encodeURIComponent(officeTopicDetailTopicId)}`, {
  credentials: 'include'
